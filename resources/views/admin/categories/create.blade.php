...
@section('content')
    <h1 class="text-4xl font-black text-[#422168] mb-6">➕ Новая категория</h1>
    <form action="{{ route('admin.categories.store') }}" method="POST" class="bg-white p-8 rounded-2xl shadow-xl max-w-2xl border-4 border-[#E8FC8C]">
        @csrf
